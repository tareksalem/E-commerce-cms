                    ...
                    controllerElements.forEach(function (controller) {
                        ...
                        if (thisEvent === "true") {
                            ...
                            if (thisEventType === "click" && thisEventType2 === "click") {
                                controller.event(`${thisEventType}`, function (e) {
                                    events++;
                                    if (events === 1) {
                                ...
                                controller.event(`${thisEventType}`, function (e) {
                                    responseThisOne(e.target);
                                    controller.event(`${thisEventType2}`, function (e) {
                                        responseThisTwo(e.target);
                                    })
                                })
                        ...
                        if  (eventType === "click" && eventType2 === "click") {
                            ...
                            if (eventType2 !== undefined) {
                                controller.event(`${eventType2}`, function (e) {
                                    responseThisOne(e.target);
                                    if (clicked === 2) {
                                        targetElements.forEach(function (targetElement) {
                            ...
                            controller.event(`${eventType}`, function (e) {
                                ...
                                if (eventType2 !== undefined) {
                                    if (eventType2 !== "mouseleave" || "mouseout") {
                                        document.body.event("mousemove", function (bEvent) {
                                            if (clicked === 0) {
                                                return null;
                                            } else {
                                                if (notElement) {
